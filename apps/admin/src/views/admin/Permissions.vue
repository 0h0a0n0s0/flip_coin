        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template #default="scope">
            <div class="action-buttons-container">
              <el-button class="action-btn-edit" @click="handleEditRole(scope.row)" :disabled="scope.row.id === 1">
                编辑
              </el-button>
              <el-button class="action-btn-delete" @click="handleDeleteRole(scope.row)" :disabled="[1, 2, 3].includes(scope.row.id)">
                删除
              </el-button>
            </div>
          </template>
