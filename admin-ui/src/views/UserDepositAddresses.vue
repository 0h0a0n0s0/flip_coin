  ...
  <div class="user-addresses-container">
    ...
    <el-card shadow="never" class="table-card" v-loading="loading">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="TRC20 地址 (T...)">
          <template #default="scope">
            {{ scope.row.tron_deposit_address_masked || scope.row.tron_deposit_address }}
          </template>
        </el-table-column>
        <el-table-column label="EVM 地址 (0x...)">
          <template #default="scope">
            {{ scope.row.evm_deposit_address_masked || scope.row.evm_deposit_address }}
          </template>
        </el-table-column>
      </el-table>
